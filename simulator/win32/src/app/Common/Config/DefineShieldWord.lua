...
function m.CheckShieldWord(_string)
	for i = 1, #m.ShieldWordTab do
		if string.find(_string, m.ShieldWordTab[i]) ~= nil then
			print("ShieldWordTab[i] = " .. m.ShieldWordTab[i] .. ", i = " .. i)
			return true
		end
	end
	return false
