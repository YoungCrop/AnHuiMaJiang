...
namespace rtchatsdk {
    ...
    void RTChatSDKMain::registerMsgCallback(const pMsgCallFunc& func)
    {
       callbackfunc = func;
        ...
        //开始录制麦克风数据
    bool RTChatSDKMain::startRecordVoice(unsigned int labelid,bool bte)
    {
//        CCLOG("==============ddddd1");
//        cocos2d::JniMethodInfo voemethodInfo;
//        CCLOG("==============ddddd2");
...
//          return NULL;
//        }
//        CCLOG("==============ddddd3",labelid);
//
//        voemethodInfo.env->CallStaticObjectMethod(voemethodInfo.classID, voemethodInfo.methodID,1,false);
//        CCLOG("==============ddddd4");
        return true;
    }
