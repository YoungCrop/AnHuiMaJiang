...
std::string CMD5::GenerateMD5(const char* buffer,int bufferlen)
{  
...
CMD5 CMD5::operator +(const CMD5& adder)  
{  
...
bool CMD5::operator ==(const CMD5& cmper)  
{  
...
std::string CMD5::GenerateMD5ForFile(const char* filePath)
{
	struct CMD5::md5_context context;
...
#define temp_buffer_size 1024
	...
	while(!feof(fileHandle)){
		...
		int length = fread(buffer,1,temp_buffer_size,fileHandle);
