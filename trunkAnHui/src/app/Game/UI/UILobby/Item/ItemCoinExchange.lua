...
local csbFile = "Csd/ILobby/Item/ItemCoinExchange.csb"

local n = {}
local m = class("ItemCoinExchange", function()
...
function m:loadCSB()
    ...
    self.btnMap["btnBG"]:setSwallowTouches(false)
    self.btnMap["iconCoin"]:setSpriteFrame(self.param.iconCoin)
