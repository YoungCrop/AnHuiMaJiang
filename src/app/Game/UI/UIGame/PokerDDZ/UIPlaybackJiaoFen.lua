...
local MngPlaybackJiaoFen = require("app.Game.UI.UIGame.PokerDDZ.MngPlaybackJiaoFen")

local csbFile = "Csd/SubGame/PokerDDZ/UIPlaybackJiaoFen.csb"
local m = class("UIPlaybackJiaoFen", function()
...
function m:ctor(replayData,gameType)
    ...
    self.playManager = MngPlaybackJiaoFen:create(self.rootNode, paramTbl, self.gameType )
